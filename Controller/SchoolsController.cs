...
public class SchoolsController : Controller
{
    ...
    public SchoolsController(DBContext context)
    {
        _context = context;
    }
    ...
    public async Task<IActionResult> Index()
    {
          return _context.Schools != null ? 
                      ...
                      Problem("Entity set 'DBContext.Schools'  is null.");
    }
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit(int id, [Bind("SchoolId,SchoolName")] School school)
    {
    ...
    public async Task<IActionResult> DeleteConfirmed(int id)
    {
        ...
        {
            return Problem("Entity set 'DBContext.Schools'  is null.");
        }
        var school = await _context.Schools.FindAsync(id);
        if (school != null)
        {
